...
public class FindUnsortedSubArrayTest {
  ...
  private FindSubArray finder = new FindUnsortedSubArray();
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][]{
        ...
        {new int[]{4, 4, 5}, new int[]{2, 3, 4, 2, 4, 4, 5, 6, 7}, 4},
        {new int[]{4, 4, 5}, new int[]{2, 4, 2, 3, 4, 5, 6, 7, 8, 9, 1, 2, 3, 4, 4, 5, 6, 7}, 13},
        ...
        {new int[]{4, 5, 3}, new int[]{2, 4, 5, 4, 4, 5, 3, 7}, 4}
    });
  }

  public FindUnsortedSubArrayTest(int[] subArray, int[] array, int index) {
